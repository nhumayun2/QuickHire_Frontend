      ...
      <div className="relative mx-auto max-w-[1440px] h-auto lg:h-[794px] flex flex-col lg:block">
        <div className="hidden lg:block absolute inset-0 w-full h-full pointer-events-none z-0">
          <Image
            ...
            className="absolute right-0 top-0 w-[860px] h-[794px] object-cover z-0"
            priority
          />
          <Image
            src={HeroPerson}
            alt="Happy man pointing at jobs"
            className="absolute bottom-0 right-[124px] w-[501px] h-[707px] object-contain z-10"
            priority
          />
          <div
            className="absolute bg-white z-20 -bottom-[260px] -right-[40px]"
            style={{
              width: "283.38px",
              height: "716.25px",
        ...
        <div className="relative z-30 px-6 pt-16 pb-24 lg:p-0 lg:absolute lg:left-[124px] lg:top-[96px] w-full lg:w-auto flex flex-col">
          <h1
